...
export const typography = {
  ...
  fontSize: { xs: '11px', sm: '13px', base: '16px', lg: '20px', xl: '24px', '2xl': '32px', '3xl': '40px', '4xl': '56px' },
  lineHeight: { tight: 1.1, snug: 1.3, normal: 1.5, relaxed: 1.7 },
  letterSpacing: { tight: '-0.02em', normal: '0', wide: '0.05em', wider: '0.1em', widest: '0.15em' },
};

export const spacing = { xs: '4px', sm: '8px', md: '16px', lg: '24px', xl: '32px', '2xl': '48px', '3xl': '64px', '4xl': '96px' };
export const borderRadius = { sm: '4px', md: '8px', lg: '12px', xl: '16px', full: '9999px' };
...
export const semantic = {
  background: { primary: colors.darkBlue, secondary: colors.white, accent: colors.lightGreen },
  text: { onDark: colors.white, onLight: colors.darkBlue, accent: colors.lightGreen, muted: 'rgba(255,255,255,0.6)' },
  border: { default: 'rgba(0,30,96,0.15)', strong: colors.darkBlue, accent: colors.lightGreen },
};
